    ...
    <div class="row">
            ...
            <table class="table table-bordered listemp">
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <button type="button" class="btn btn-danger removeline" onclick="removeline($(this))">-</button>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="col-lg-7">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?php $model->isNewRecord ? $model->Date = date('Y-m-d') : $model->Date ?>
            ...
            <div class="form-group">
                <div class="pull-left">
                    ...
                    <span><?= Html::button('ตรวจสอบ', ['id' => 'check', 'class' => 'btn btn-info']) ?></span>
                </div>
