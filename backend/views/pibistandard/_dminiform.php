...
?>
    <div class="row">
        <div class="col-lg-12">
            <form action="?r=pibistandard/createdlist" id="dlist">
                <table class="table table-bordered dlistt">
                    ...
                    <tr>
                        ...
                        <td><input type="text" readonly name="amountx[]" class="form-control amounts"></td>
                        <td><input type="text" readonly name="ratex[]" class="form-control rates"></td>
