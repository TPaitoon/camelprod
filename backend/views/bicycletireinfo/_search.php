...
<div class="bicycletire-info-search">
    ...
    <div class="row">
        ...
        <div class="col-lg-2" id="starts">
            <?php $model->startdate == '' ? $model->startdate = date('d/m/Y') : BicycletireinfoSearch::ConvertDate($model->startdate) ?>
        ...
        <div class="col-lg-2" id="ends">
            <?php $model->enddate == '' ? $model->enddate = date('d/m/Y') : BicycletireinfoSearch::ConvertDate($model->enddate) ?>
